...
class NearestFragment : Fragment() {
    ...
    override fun onCreateView(
        ...
        recyclerView = inflater.inflate(R.layout.fragment_nearest, container, false) as RecyclerView?
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        adapter = context?.let { NearestAdapter(it) }
    ...
    override fun onStart() {
        super.onStart()
//        adapter?.setRideList(nearestRidesList)
    }
    ...
    companion object {
        ...
        var nearestRidesList: List<Ride>? = null
    }
}